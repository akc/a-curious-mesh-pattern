...
\bibitem{Brualdi2012}
Richard~A. Brualdi and Emeric Deutsch.
\newblock Adjacent {$q$}-cycles in permutations.
\newblock {\em Ann. Comb.}, 16(2):203--213, 2012.

\bibitem{Cl2022}
Anders Claesson.
\newblock From {H}ertzsprung's problem to pattern-rewriting systems.
\newblock {\em Algebraic Combinatorics}, 5(6):1257--1277, 2022.

\bibitem{foata}
Dominique Foata.
\newblock \'{E}tude alg\'ebrique de certains probl\'emes d'analyse combinatoire
  et du calcul des probabilit\'es.
\newblock {\em Publ. Inst. Statist. Univ. Paris}, 14:81--241, 1965.

\bibitem{shading}
\'I. Hilmarsson, I.~J\'onsd\'ottir, S.~Sigurdard\'ottir, L.~Vidarsd\'ottir, and
  Henning Ulfarsson.
\newblock Wilf-classification of mesh patterns of short length.
\newblock {\em Electronic Journal of Combinatorics}, 22, 2015.

\bibitem{OEIS}
OEIS~Foundation Inc.
\newblock The {O}nline {E}ncyclopedia of {I}nteger {S}equences.
\newblock \texttt{https://oeis.org/}, 2023.

\bibitem{EC1}
Richard~P. Stanley.
\newblock {\em Enumerative combinatorics}, volume~1 of {\em Cambridge Studies
