...
see \cite[Ex.\ 1.32b]{EC1}.  Similarly, $\pi(i)=i$ is a
\emph{skew strong fixed point} if $j<i\Rightarrow \pi(j)>\pi(i)$ and
$j>i\Rightarrow \pi(j)<\pi(i)$. Equivalently~\cite{Bra11}, strong fixed
point and skew strong fixed point are occurrences of the patterns
\[
  \pattern{}{1}{1/1}{1/0,0/1}
  \quad\text{and}\!\quad
  \pattern{}{1}{1/1}{0/0,1/1}
\]
respectively. It is easy to see that strong fixed points correspond to
skew strong fixed points under Foata's fundamental transformation. What
other properties of the cycle structure of $\pi$ can be neatly expressed
in terms of occurrences of mesh patterns in $\sigma$?  Are the examples
presented here special cases of a more general phenomena?
